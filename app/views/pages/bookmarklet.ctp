...
<p><?php __('Bookmarklet (Buttons) are links you add to your browser\'s Bookmarks Toolbar. This bookmarklet is to undistractify your currently viewed website in a snap.') ?></p>

<p><?php __('First, make sure your Bookmarks Toolbar is visible.') ?></p>
...
<p>
	...
	<?php __('to your Bookmarks Toolbar to install.') ?> 
</p>
...
<p><?php __('undistraction makes sure you have to wait at least a pre-defined time interval before accessing a time-wasting website. Currently it is set to 1 hour.') ?></p>
...
<p><?php __('If that is true, all you have to do is replace your existing bookmarks with your brand-new, <em>undistractified</em> ones. undistraction will then do the heavy work for you: each time you click a bookmark, it will check the last time you visited this website; if it was within the pre-defined time interval, you will get redirected to a blank page (not entirely blank, in fact). Otherwise, you are happy to go.') ?></p>
...
<p><?php __('What if I save them there for later viewing, you may ask. Well, undistraction is not del.icio.us; using it as a bookmarking service is plain wrong.') ?></p>
...
<p>
	<?php __('Yeah, undistraction\'s layout (and even this FAQ) is heavily inspired by Marco Arment\'s ') ?>
